            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <p>
                  ...
                  <span class="hidden-xs"> (<?php echo $this->session->userdata("namalvl"); ?>)</span>
                  <?php 
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('users/changedata'); ?>" class="btn btn-success btn-flat"><i class="fa fa-user" aria-hidden="true"></i> Profil</a>
                </div>
